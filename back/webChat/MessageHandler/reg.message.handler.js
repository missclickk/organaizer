...
exports.regMsg = exports.RegMsgHanlder = void 0;
...
var RegMsgHanlder = /** @class */ (function (_super) {
    __extends(RegMsgHanlder, _super);
    function RegMsgHanlder(msgStorage, timersStorage, resurce) {
        var _this = _super.call(this) || this;
        _this.msgStorage = msgStorage;
        _this.timersStorage = timersStorage;
        _this.resurce = resurce;
        return _this;
    }
    RegMsgHanlder.prototype.initUser = function (socket) {
        this.timersStorage.deleteItemByName(socket.roomId);
        this.msgStorage.updateItemByName(socket.roomId, ["clients"], socket.socket);
    };
    RegMsgHanlder.prototype.handelMsg = function (socket, msg) {
        return __awaiter(this, void 0, void 0, function () {
            var roomID, cacheChat, chat, text;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        roomID = msg.roomID;
                        this.initUser(socket);
                        cacheChat = this.msgStorage.getItemByName(roomID, "chat");
                        return [4 /*yield*/, this.resurce.getChat(roomID)];
                    case 1:
                        chat = _a.sent();
    ...
    return RegMsgHanlder;
}(ObserverWrapper_1.ObservableWrapper));
exports.RegMsgHanlder = RegMsgHanlder;
exports.regMsg = new RegMsgHanlder(MsgStorage_1.msgStorage, TimersStorage_1.timersStorage, chatbot_resurce_1.chatResurce);
